...
var GestureRecognition = function(providedConfig) {
  this.config={
    ...
    'gestures':{
        'up':[['NE', 'NE', 'NE', 'N'],['NE', 'NE', 'NE', 'N'],['N', 'N', 'N', 'N'],['NE', 'NE', 'NE', 'N'],['NE', 'NE', 'NE', 'N'],['N', 'N', 'N', 'N'],['NE', 'NE', 'NE', 'N'],['NE', 'NE', 'NE', 'N'],['N', 'N', 'N', 'N']],
        'right':[['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W'],['WS', 'W', 'W', 'W']],
        'down':[['WS', 'WS', 'WS', 'S'],['WS', 'WS', 'WS', 'S'],['S', 'S', 'S', 'S'],['WS', 'WS', 'WS', 'S'],['WS', 'WS', 'WS', 'S'],['S', 'S', 'S', 'S'],['WS', 'WS', 'WS', 'S'],['WS', 'WS', 'WS', 'S'],['S', 'S', 'S', 'S']],
        'left':[['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E'],['NE', 'E', 'E', 'E']],
      },
...
// Version.
GestureRecognition.VERSION = '0.0.3';
